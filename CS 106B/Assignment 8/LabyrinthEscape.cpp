/*
 * This code allows users to explore the contents of each pointer
 * in a pointer maze using the debugger function
 */
 ...
 */
const string MyName = "Avash Shrestha and Becca Crosse";

/* these constants contain the paths out of your mazes. */
const string ThePathOutOfMyMaze = "ESSWNSEEESWENNWN";
