...
export default class User {
  ...
  static async loadOrCreate(id) { // static methds can be called on the class.
    ...
    try {
      ...
      let user = await apiRequest("POST", "/users", { "id": id });
      user = await apiRequest("PATCH", `/users/${id}`);
      userObject = new User(user);
    }
    return userObject;
  }
